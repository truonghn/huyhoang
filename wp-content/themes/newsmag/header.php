				...
				<div class="col-md-4 header-logo">
				  <div class='site-logo'>
					...
					<div class="title-wrapper">
						...
						<p class="site-description" <?php echo ( ! empty( $header_textcolor ) ) ? 'style="color:#' . esc_attr( $header_textcolor ) . '"' : ''; ?>><?php echo wp_kses_post( get_bloginfo( 'description', 'display' ); ); /* WPCS: xss ok. */ ?></p>
					</div>
				</div>
