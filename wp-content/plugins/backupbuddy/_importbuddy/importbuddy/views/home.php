...
echo "<script>jQuery( '#pageTitle' ).html( 'Step 1: Select Backup to Restore' );</script>";
...
<div id="pb_advanced_modal" style="display: none;">
	<div class="modal">
		...
		<div class="modal_content">
			...
			<input type="checkbox" name="migrateHtaccess" value="1" CHECKED> Migrate .htaccess file URLs & paths (if URL changes).
			<br><br>
